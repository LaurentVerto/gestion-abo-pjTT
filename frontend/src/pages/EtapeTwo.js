...
function EtapeTwo() {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "main-content bg-[#1d1d21] w-screen h-screen fontAbe pb-0 overflow-y-scroll relative " },
            ...
            react_1.default.createElement("div", { className: "absolute h-33 -bottom-80 bg-[#f8f8f8] w-[100vw] z-0 md:hidden" }),
            react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1440 320", className: "absolute rotate-180 -bottom-50 left-0 w-full z-2 md:hidden" },
                react_1.default.createElement("path", { fill: "#f8f8f8", fillOpacity: "1", d: "M0,224L40,208C80,192,160,160,240,144C320,128,400,128,480,154.7C560,181,640,235,720,218.7C800,203,880,117,960,85.3C1040,53,1120,75,1200,117.3C1280,160,1360,224,1400,256L1440,288L1440,0L0,0Z" })),
            react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1440 320", className: "absolute rotate-180 -bottom-47 left-0 w-full z-1 md:hidden" },
                react_1.default.createElement("defs", null,
                    react_1.default.createElement("linearGradient", { id: "monDegrade", x1: "0%", y1: "0%", x2: "100%", y2: "0%" },
                        react_1.default.createElement("stop", { offset: "0%", stopColor: "#60A8FE" }),
                        react_1.default.createElement("stop", { offset: "100%", stopColor: "#4950FF" }))),
