    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: " main-content container bg-[#1d1d21] w-[100vw] h-[100vh] z-25 fontAbe pb-0  overflow-y-scroll" },
            ...
            react_1.default.createElement("div", { className: "p-10 text-xs " },
                ...
                react_1.default.createElement("img", { src: etapeThree, alt: "image etape", className: "mt-10 ml-10 mb-10" }),
                react_1.default.createElement("div", { className: "flex justify-center gap-10 mb-20" },
                    ...
                    react_1.default.createElement(react_router_dom_1.Link, { to: "/ajouter-contrat", className: "bg-gray-500 p-2 rounded-lg animate-pulse " }, "Entrer dans le site"))))));
}
