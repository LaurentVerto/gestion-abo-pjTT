...
function Accueil() {
    return (react_1.default.createElement("div", { className: "container bg-white w-[100vw] h-[100vh] z-0 fontAbe pb-0 " },
        ...
        react_1.default.createElement("div", { className: "flex flex-col justify-center items-center mt-17" },
        ...
        react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1440 320", className: "absolute bottom-4" },
            react_1.default.createElement("defs", null,
                react_1.default.createElement("linearGradient", { id: "monDegrade", x1: "0%", y1: "0%", x2: "100%", y2: "0%" },
                    react_1.default.createElement("stop", { offset: "0%", "stop-color": "#60A8FE" }),
                    react_1.default.createElement("stop", { offset: "100%", "stop-color": "#4950FF" }))),
            react_1.default.createElement("path", { fill: "url(#monDegrade)", "fill-opacity": "1", d: "M0,256L60,245.3C120,235,240,213,360,181.3C480,149,600,107,720,128C840,149,960,235,1080,250.7C1200,267,1320,213,1380,186.7L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z" }))));
}
