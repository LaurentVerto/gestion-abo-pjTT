    ...
    return(
        <>
            <div className=" main-content container bg-[#1d1d21] w-[100vw] h-[100vh] z-25 fontAbe pb-0  overflow-y-scroll">
                ...
                <img src={etapeThree} alt="image etape" className="mt-10 ml-10 mb-10" />
                <div className="flex justify-center gap-10 mb-20">
                    <Link to="/EtapeTwo" className="bg-gray-700 p-2 rounded-lg ">Etape Précédente</Link>
                    <Link to="/ajouter-contrat" className="bg-gray-500 p-2 rounded-lg animate-pulse ">Entrer dans le site</Link>
                </div>
                </div>
            </div>
        </>
