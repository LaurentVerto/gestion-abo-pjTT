    ...
    return(
        <>
            <div className="main-content container bg-[#1d1d21] w-screen h-screen fontAbe pb-0 overflow-y-scroll relative ">
                ...
                <div className="absolute h-33 -bottom-63 bg-[#f8f8f8] w-[100vw] z-0"></div>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 1440 320"
                    className="absolute rotate-180 -bottom-30 left-0 w-full z-2"
                >
                    <path
                        fill="#f8f8f8"
                        fillOpacity="1"
                ...
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 1440 320"
                    className="absolute rotate-180 -bottom-27 left-0 w-full z-1"
                >
                    <defs>
                        <linearGradient id="monDegrade" x1="0%" y1="0%" x2="100%" y2="0%">
                            <stop offset="0%" stopColor="#60A8FE" />
