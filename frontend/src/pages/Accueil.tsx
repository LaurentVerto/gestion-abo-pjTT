...
function Accueil() {
    return (
        <>
            <div className=" w-[100vw] h-[100dvh] z-0 fontAbe border-red-500  ">
                ...
                <div className="flex flex-col justify-center items-center mt-[5dvh]">
                    <p className="">Bienvenue sur</p>
                    <h1 className="text-black text-xl linear-title font-bold ">SplitPay</h1>
                    <p className=" w-80 text-justify mt-10 text-sm">Une application qui vous permet d’avoir, en un coup d’œil, une vue claire de vos abonnements et de vos paiements en plusieurs fois.</p>

                    <a className="mt-8 text-center underline text-[#009CEA]" href="https://linktr.ee/LFPCDEV" target="blank">🔗 Me suivre 🔗 </a>
                </div>
