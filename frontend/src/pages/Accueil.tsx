...
function Accueil() {
    return (
        <>
            <div className=" w-[100vw] h-[100dvh] z-0 fontAbe border-red-500 flex flex-col justify-center">
                ...
                <div className="flex flex-col justify-center items-center gap-[5vh]">
                    <img src={ICON_SP} alt="logo-xs" className=" z-1 h-35 mb-10" />
                    <div>
                    <p className="">Bienvenue sur</p>
                    <h1 className="text-black text-xl linear-title font-bold  text-center">SplitPay</h1>
                    </div>
                    <p className=" w-80 text-justify  text-sm md:text-lg ">Une application qui vous permet d’avoir, en un coup d’œil, une vue claire de vos abonnements et de vos paiements en plusieurs fois.</p>

                    <a className="text-center underline text-[#009CEA]" href="https://linktr.ee/LFPCDEV" target="blank">🔗 Me suivre 🔗 </a>
                </div>
