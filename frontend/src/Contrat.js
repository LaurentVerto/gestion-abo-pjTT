...
//
    ...
    const supprimerContrat = (idContrat) => {
        ...
        if(dataLocal){
            ...
            const listeMaj = anciensContrats.filter(e => e.id !== idContrat)
            ...
            <ul>
                ...
                <li className="flex items-center justify-center mt-5">
                    <div className="group">
                        ...
                        <div className="flex shadow-inner w-[60%] min-w-[350px] justify-between p-3 pr-10 pl-10 rounded-lg" key={contrat.id}>
