...
function Contrat() {
    ...
    return (
        <div className="main-content">
            ...
            <div className="overflow-scroll h-110">
                    ...
                    {mesContrats.filter(contrat => {
                        ...
                        return (
                            <li className="flex items-center justify-center mt-2">
                                ...
                                <div className="flex shadow-inner w-[60%] min-w-[270px] justify-between p-3 pr-5 pl-5 rounded-lg items-center" key={contrat.id}>
                ...
                {mesContrats.filter(contrat => {
                    ...
                    return (
                        ...
                        <li className="flex items-center justify-center mt-1" key={contrat.id}>
                            <div className="group">
                            </div>
                ...
                {mesContrats.filter(contrat => {
                    ...
                    return (
                        ...
                        <li className="flex items-center justify-center mt-2" key={contrat.id}>
                            <div className="group">
                            </div>
