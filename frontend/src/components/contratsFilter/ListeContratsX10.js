...
function ListeContratsX10() {
    ...
    const contractsFilter = myContracts.filter((contrat) => contrat.type === "Paiement x10");
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "flex items-center mt-3", onClick: handleDrop },
            react_1.default.createElement("h3", { className: "text-xs text-left ml-3 md:text-lg hover:cursor-pointer " }, "Paiements x10"),
