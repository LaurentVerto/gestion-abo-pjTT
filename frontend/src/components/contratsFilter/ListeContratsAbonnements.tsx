    ...
    return (
        ...
        <>
            ...
            <div className="flex items-center mt-3" onClick={handleDrop}>
                ...
                <h3 className="text-xs text-left ml-3 ">Abonnements</h3>
                ...
                myContracts.filter(contrat => {
                    ...
                    return (
                        <ul className="flex justify-center w-[100%] flex-col items-center relative mt-0 gap-3 subpixel-antialiased">
                            ...
                            <li key={contrat.id} className={`${contrat.statusAbo ? "border-l-[#5B975D]" : "border-l-[#975B5B]"} bg-[#282830] flex w-[90%] relative justify-between p-1  border-l-4  rounded-br-[5px] rounded-tr-[5px] drop-figma gradient-border mt-3 `}>
                                <div className= {`${contrat.statusAbo ? "bg-[#5B975D]" : "bg-[#975B5B]"} design-bar absolute left-0 top-0 h-[100%] w-1`}></div>
                                <div className="ml-0 flex flex-col justify-between ">
                                    <strong className=" text-md  leading-none">{contrat.nom} | <span className="font-sans text-xs">{contrat.prix} €</span></strong>
                                    <p className="text-xs font-sans font-light">{contrat.statusAbo ? "Abonnement actif" : "Abonnement Inactif"}</p>
                                ...
                                <div className="flex flex-col justify-center leading-none items-end relative group " onClick={() => handleUpdate(contrat.id)}>
                                    <div className={`${contrat.statusAbo ? "bg-[#5B975D]" : "bg-[#975B5B]"} w-12 h-5 rounded-xl
                                        ...
                                        <div className={`${contrat.statusAbo ? "right-0" : "right-6"} w-6 h-6 bg-white rounded-full absolute top-3 
                                transition-all  `}></div>
                                    </div>
                                </div>
                            </li>
