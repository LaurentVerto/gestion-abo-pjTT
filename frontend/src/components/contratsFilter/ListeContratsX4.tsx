...
function ListeContratsX4() {
    ...
    const handleDrop = () => {
     ...
     const contractsFilter = myContracts.filter(
        (contrat) => contrat.type === "Paiement x4"
    );
    ...
    return(
        ...
        <div className="flex items-center mt-3" onClick={handleDrop}>
                ...
                <h3 className="text-xs text-left ml-3 md:text-lg hover:cursor-pointer ">Paiements x4</h3>
                        ...
                        return (
                            ...
                            <div className="ml-3 flex flex-col justify-between ">
                                ...
                                <div className="flex items-center gap-2 " >
                                    ...
                                    <svg onClick={(e) => handleUp(contrat.id, e)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-plus-icon lucide-plus"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                                </div>
                            </div>
