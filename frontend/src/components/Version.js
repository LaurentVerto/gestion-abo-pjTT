...
function Version() {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("p", { className: "absolute text-[9px] top-2 left-2 z-50 mix-blend-difference" },
            "By ",
            react_1.default.createElement("br", null),
            " LFPC-DEV"),
        overlay &&
            react_1.default.createElement("div", { onClick: handleVersionOverlay, className: "overlay  w-[100%] h-[100%] bg-black/70 absolute z-49 " },
        ...
        react_1.default.createElement("p", { onClick: handleVersionOverlay, className: "absolute border cursor-pointer rounded-full right-2 top-2 w-7 h-7 flex justify-center items-center text-base drop-figma z-50 mix-blend-difference" }, "?")));
}
